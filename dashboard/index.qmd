    ...
    fig_map.add_trace(go.Scattergeo(
        ...
        marker=dict(
            ...
            colorbar=dict(
                ...
                thickness=14, len=0.65, x=1.00, xanchor="left",
...
fig_map.update_layout(
    **L(margin=dict(l=0, r=0, t=0, b=0), height=360),
    updatemenus=[dict(
        type="buttons", buttons=buttons,
        direction="down", showactive=True, active=0,
        bgcolor="rgba(248,250,252,0.85)", bordercolor="#e2e8f0", borderwidth=1,
        font=dict(size=16, family=FONT),
        x=0.01, xanchor="left", y=0.97, yanchor="top",
        pad=dict(b=6, t=6, r=12, l=12),
    )],
    legend=dict(
...
:::
![](infraestructura.jpeg){width="100%" style="border-radius:12px; object-fit:cover; max-height:220px; display:block; margin:0.8rem auto;"}
...
![](Pobreza.jpeg){width="100%" style="border-radius:12px; object-fit:cover; max-height:220px; display:block; margin:0.8rem auto;"}
...
fig_sc.update_layout(
    **L(margin=dict(l=20, r=20, t=30, b=50), height=320),
...
fig_don.update_layout(
    **L(margin=dict(l=10, r=10, t=20, b=20), height=300),
    showlegend=False,
    annotations=[dict(
