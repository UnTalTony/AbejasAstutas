...
fig_map.update_layout(
    **L(margin=dict(l=0, r=0, t=0, b=0), height=300),
    updatemenus=[dict(
    ...
    geo=dict(
        scope="world", showland=True, landcolor="#f1f5f9",
...
![](Pobreza.jpeg){width="100%" style="border-radius:10px; object-fit:cover; max-height:500px; display:block; margin:0.5rem auto;"}
...
![](egresados.jpeg){width="100%" style="border-radius:10px; object-fit:cover; max-height:500px; display:block; margin:0.5rem auto;"}
