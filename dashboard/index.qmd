...
fig_map.update_layout(
    **L(margin=dict(l=0, r=0, t=0, b=0), height=260),
    updatemenus=[dict(
...
![](infraestructura.jpeg){width="100%" style="border-radius:10px; object-fit:cover; max-height:190px; display:block; margin:0.6rem auto;"}

*Fuente: [Facebook — publicación de referencia](https://www.facebook.com/share/p/1GZVURVcwn/){style="font-size:0.78rem; color:#64748b;"}*
...
![](Pobreza.jpeg){width="100%" style="border-radius:10px; object-fit:cover; max-height:500px; display:block; margin:0.6rem auto;"}

*Imagen proporcionada por Jperez . Fuente: [Instagram — Jperez](https://www.instagram.com/p/DXfLOqzFhSp/?igsh=MThhc2d1M3NscWl2NQ==){style="font-size:0.78rem; color:#64748b;"}*
...
fig_sc.update_layout(
    **L(margin=dict(l=20, r=20, t=20, b=65), height=290),
...
fig_don.update_layout(
    **L(margin=dict(l=10, r=10, t=15, b=15), height=270),
    showlegend=False,
    annotations=[dict(
